...
class SegNet(nn.Module):
    ...
    Args:
        ...
        n_init_features (int): number of input features in the first convolution
    ...
    def forward(self, x):
        ...
        for i in range(0, 6):
            feat = self.decoders[i](feat, indices[5 - i], unpool_sizes[5 - i])
    ...
    def decode(self, feat, indices, unpool_sizes):
        for i in range(0, 6):
            feat = self.decoders[i](feat, indices[5 - i], unpool_sizes[5 - i])
